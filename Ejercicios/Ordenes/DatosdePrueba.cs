...
public class DatosdePrueba
{
    ...
    public void CrearOrden()
    {
        ...
        while(true)
        {
            ...
            Console.WriteLine ("Subtotal de la orden: " + nuevaOrden.Subtotal);
            Console.WriteLine ("Impuesto de la orden: " + nuevaOrden.Impuesto);
            Console.WriteLine ("Total de la orden: " + nuevaOrden.Total);
            Console.WriteLine ();
    ...
    public void ListarOrdenes()
    {
        ...
        Console.WriteLine("================");
        Console.WriteLine("");  
        Console.WriteLine("Codigo | Fecha | Cliente | Vendedor");
        ...
        {
            Console.Write(orden.Codigo + " | " + orden.Fecha);
            Console.WriteLine(" | " + orden.Cliente.Nombre + " | " + orden.Vendedor.Nombre);
            Console.WriteLine("  L." + orden.Subtotal + " | L." + orden.Impuesto + " | L." + orden.Total);
